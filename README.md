...
[**Next Prime Number**](https://github.com/ixenocider/Martyr2sMegaProjectList/blob/master/src/NextPrimeNumber/Progam.cs) – Have the program find prime numbers until the user chooses to stop asking for the next one.

[**Find Cost of Tile to Cover W x H Floor**](https://github.com/ixenocider/Martyr2sMegaProjectList/blob/master/src/FindCostOfTile/Progam.cs) – Calculate the total cost of tile it would take to cover a floor plan of width and height, using a cost entered by the user.
