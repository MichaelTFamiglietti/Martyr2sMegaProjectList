...
[**Next Prime Number**](https://github.com/ixenocider/Martyr2sMegaProjectList/blob/master/src/NextPrimeNumber/Prorgam.cs) – Have the program find prime numbers until the user chooses to stop asking for the next one.
