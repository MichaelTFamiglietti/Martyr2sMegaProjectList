...
[**Find PI to the Nth Digit**](https://github.com/ixenocider/Martyr2sMegaProjectList/blob/master/src/PiToNthDigit/Program.cs) – Enter a number and have the program generate PI up to that many decimal places. Keep a limit to how far the program will go.

[**Fibonacci Sequence**](https://github.com/ixenocider/Martyr2sMegaProjectList/blob/master/src/FibonacciSequence/Program.cs) – Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.

[**Prime Factorization**](https://github.com/ixenocider/Martyr2sMegaProjectList/blob/master/src/PrimeFactorization/Program.cs) – Have the user enter a number and find all Prime Factors (if there are any) and display them.

[**Next Prime Number**](https://github.com/ixenocider/Martyr2sMegaProjectList/blob/master/src/NextPrimeNumber/Program.cs) – Have the program find prime numbers until the user chooses to stop asking for the next one.

[**Find Cost of Tile to Cover W x H Floor**](https://github.com/ixenocider/Martyr2sMegaProjectList/blob/master/src/FindCostOfTile/Program.cs) – Calculate the total cost of tile it would take to cover a floor plan of width and height, using a cost entered by the user.

**Mortgage Calculator** – Calculate the monthly payments of a fixed term mortgage over given Nth terms at a given interest rate. Also figure out how long it will take the user to pay back the loan.

**Change Return Program** – The user enters a cost and then the amount of money given. The program will figure out the change and the number of quarters, dimes, nickels, pennies needed for the change.

[**Binary to Decimal and Back Converter**](https://github.com/ixenocider/Martyr2sMegaProjectList/blob/master/src/BinaryToDecimalAndBackConverter/Program.cs) – Develop a converter to convert a decimal number to binary or a binary number to its decimal equivalent.

[**Calculator**](https://github.com/ixenocider/Martyr2sMegaProjectList/blob/master/src/Calculator/Program.cs) – A simple calculator to do basic operators. Make it a scientific calculator for added complexity.
...
[**Reverse a String**](https://github.com/ixenocider/Martyr2sMegaProjectList/blob/master/src/ReverseAString/Program.cs) – Enter a string and the program will reverse it and print it out.
